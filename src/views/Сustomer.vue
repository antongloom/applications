<template>
  <div class="Customer">
  	<div class="Customer-Content">
  		<div class="Customer-Title">Регистрация Заказчик</div>
  		<form class="Customer-Form" @submit.prevent="submitHandler">
			 ...
			 <div class="Customer-Item">
				...
				<div class="Customer-Text">Уже есть аккаунт? <router-link to="/loginCustomer"><span>Войти</span></router-link></div>	
  		</form>
  	</div>
  </div>
</template>
